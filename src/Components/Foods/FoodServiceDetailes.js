...
const FoodServiceDetailes = ({foodData}) => {
                    ...
                    <div className="lg:mt-11 mt-10">
                        <div className="flex flex-row justify-between">
                            ...
                            <div className="flex">
                                ...
                                <input id="counter" aria-label="input" className="border border-gray-300 h-full text-center w-14 pb-1" type="text"  onChange={(e) => e.target.value} />
                        ...
                        <div className=" flex flex-row justify-between items-center mt-4">
                            ...
                            <svg id="rotateSVG" className={"focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer transform "} width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
